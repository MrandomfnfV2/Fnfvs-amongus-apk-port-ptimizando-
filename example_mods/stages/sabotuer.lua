...
function onCreate()
makeLuaSprite('spaceHitbox',nil,0,0)
makeGraphic('spaceHitbox',1280,180,'FFFF00')
setObjectCamera('spaceHitbox','camOther')
setProperty('spaceHitbox.alpha',0.25)
setProperty('spaceHitbox.visible',false)
addLuaSprite('spaceHitbox')
	...
	scaleObject('shadowMitori',2 ,2)
	scaleObject('shadowBF',2 ,2)
	scaleObject('shadowGF',2 ,2)
	scaleObject('shadowshiro',2 ,2)
	scaleObject('ele',2 ,2)
	-----------------------------------------
...
function onUpdate()
if getMouseY('camOther') <= 180 and mouseClicked('left') or getMouseY('camOther') <= 180 and mousePressed('left') then
setProperty('spaceHitbox.visible',true)
elseif getMouseY('camOther') > 180 or mouseReleased('left') then
setProperty('spaceHitbox.visible',false)
end
if keyboardJustPressed('SPACE') or (getMouseY('camOther') <= 180 and mouseClicked('left')) and dodgetiming == true then
spacePressed = true
dodgesuccess = true;
	  ...
	  dodgetiming = false;
--debugPrint('fuck you')
elseif not keyboardJustPressed('SPACE') or (getMouseY('camOther') <= 180 and not mouseClicked('left'))then
spacePressed = false
end
