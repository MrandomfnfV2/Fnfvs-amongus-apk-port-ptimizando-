...
function onCreate()
	...
	addLuaSprite('deadbf')
	scaleObject('sky',2 ,2)
	scaleObject('bgrock',2 ,2)
	scaleObject('back1',2 ,2)
	scaleObject('floor',2 ,2)
	scaleObject('deadgf',2 ,2)
	scaleObject('deadbf',2 ,2)
